...
public final class ClientOverrideConfiguration
    ...
    private ClientOverrideConfiguration(DefaultClientOverrideConfigurationBuilder builder) {
        ...
        this.executionInterceptors = Collections.unmodifiableList(builder.executionInterceptors);
    ...
    public interface Builder extends CopyableBuilder<Builder, ClientOverrideConfiguration> {
         ...
         */
        default Builder header(String name, String value) {
         ...
         * @return This object for method chaining.
         */
        Builder header(String name, List<String> values);
         ...
         * {@link #executionInterceptor(ExecutionInterceptor)}.
         *
         * <p>
         ...
         */
        @SdkInternalApi
        Builder executionInterceptor(ExecutionInterceptor executionInterceptor);
    ...
    private static final class DefaultClientOverrideConfigurationBuilder implements Builder {
        ...
        @Override
        public Builder headers(Map<String, List<String>> additionalHttpHeaders) {
            this.headers = CollectionUtils.deepCopyMap(additionalHttpHeaders);
            return this;
        }
        ...
        @Override
        public Builder executionInterceptor(ExecutionInterceptor executionInterceptor) {
